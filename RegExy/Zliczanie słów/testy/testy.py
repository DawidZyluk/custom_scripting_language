...
class TestZliczanie_slow(unittest.TestCase):
    def test_1(self):
        cmd_str = "python ../zliczanie_slow.py test_1_input.txt test_1_output.txt"
        subprocess.run(cmd_str, shell=True)
        self.assertTrue(filecmp.cmp("test_1_output.txt", "test_1_correct.txt"))

    def test_2(self):
        cmd_str = "python ../zliczanie_slow.py test_2_input.txt test_2_output.txt"
        subprocess.run(cmd_str, shell=True)
